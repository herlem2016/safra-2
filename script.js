...
function ObtenerItem(catalogo, item) {
    ...
    switch (catalogo) {
        ...
        case "proyectos":
            ...
            '<img class="img-pro" src="' + (new RegExp(".pdf", "gi").test(GetValor(item, "primerimg")) ? "img/pdf.png" : (url + "/src-img/comunicados/_" + clave + "/" + GetValor(item, "primerimg"))) + '?v=' + Math.random() + '" />' +
